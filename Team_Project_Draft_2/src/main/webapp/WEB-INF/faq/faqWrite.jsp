...
<form:form commandName="fq" method="post" action="write.fq">
	<table id="table-main">
		<tr>
			<th id="th-font">Q. </th>
			<td>
		...
		<tr>
			...
			<form:errors class="err" path="fcontent"/>
			</td>
		</tr>
		</table>
		<br>
		<input type="submit" value="추가하기" id="btn-btn-sub" style="cursor: pointer;">
