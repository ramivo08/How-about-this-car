...
<form:form commandName="bd" method="post" action="write.bd" enctype="multipart/form-data">
	<table id="table-main">
		<tr>
			<th id="th-fff">제목</th>
			<td>
			<input id="text-td" type="text" name="title" value="${bd.title }" placeholder="제목을 입력해주세요" required>
		...
		<tr>
			<th id="th-fff">작성자</th>
			<td><input id="text-td" type="text" name="writer" value="관리자" readonly></td>
		</tr>
		...
		<tr>
			<th id="th-fff">글 내용</th>
			<td>
			<textarea id="contents" style="resize:none;" name="content" rows="15" cols="80" placeholder="내용을 입력해주세요" required></textarea>
		...
		<input type="button" id="btn-btn-list" value="목록보기" onClick="location.href='list.bd'" style="cursor: pointer;">
